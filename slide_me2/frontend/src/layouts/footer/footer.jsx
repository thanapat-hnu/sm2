...
function Footer() {
    ...
    useEffect(() => {
        if (location.pathname === '/home') {
            ...
            setPage('list');
        } else if (location.pathname === '/chatlist') { // เปลี่ยนเป็น /chatlist
            setPage('chat');
